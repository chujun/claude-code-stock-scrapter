...
- [ ] 返回股票列表
- [ ] 列表非空
- [ ] 每只股票有 stock_code, stock_name 字段
...
- [ ] 正确OHLC关系通过
- [ ] 错误OHLC关系失败并修正
- [ ] 修正后 high >= max(OHLC), low <= min(OHLC)
